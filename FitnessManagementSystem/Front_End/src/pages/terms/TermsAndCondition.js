...
export default function TermsAndCondition() {
  return (
    <div>
      ...
      Welcome to www.fitness-hub.com This site is provided as a service to our visitors and may be used for informational purposes only. Because the Terms and Conditions contain legal obligations, please read them carefully.
      ...
      <h4>6. EXCLUSIONS AND LIMITATIONS</h4>
      ...
      <h4>9. COPYRIGHT AND TRADEMARK NOTICE</h4>
      ...
      <div className="pt-1 mb-4">
        <a className="btn btn-dark btn-lg btn-block" href='/register'>Go Back To Registration</a>
      </div>
